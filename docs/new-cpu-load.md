...
----------
```powershell
PS> ./new-cpu-load.ps1 -Percent <Int32> -Seconds <Int32> [-Cores <Int32>] [<CommonParameters>]

PS> ./new-cpu-load.ps1 -Percent <Int32> -Minutes <Int32> [-Cores <Int32>] [<CommonParameters>]
...
-------
```powershell
PS > .\Start-CpuLoad.ps1 -Percent 80 -Minutes 15
...
-------
```powershell
PS > .\Start-CpuLoad.ps1 -Percent 50 -Seconds 30
...
-------
```powershell
PS > .\Start-CpuLoad.ps1 -Percent 100 -Minutes 5 -Cores 2

...
----------
```powershell
PS> ./write-braille.ps1 [[-text] <String>] [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of write-braille.ps1 as of 01/25/2024 13:58:43)*

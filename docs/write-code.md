...
----------
```powershell
PS> ./write-code.ps1 [[-color] <String>] [[-speed] <Int32>] [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of write-code.ps1 as of 01/25/2024 13:58:43)*

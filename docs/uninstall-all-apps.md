...
----------
```powershell
/home/markus/Repos/PowerShell/scripts/uninstall-all-apps.ps1 [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of uninstall-all-apps.ps1 as of 11/08/2024 12:37:57)*

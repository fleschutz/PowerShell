The *convert-mysql2csv.ps1* Script
===========================
...
----------
```powershell
/Repos/PowerShell/scripts/convert-mysql2csv.ps1 [[-server] <String>] [[-database] <String>] [[-username] <String>] [[-password] <String>] [[-query] <String>] [<CommonParameters>]

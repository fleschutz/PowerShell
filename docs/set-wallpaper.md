...
----------
```powershell
/home/markus/Repos/PowerShell/scripts/set-wallpaper.ps1 [[-ImageFile] <String>] [[-Style] <String>] [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of set-wallpaper.ps1 as of 11/08/2024 12:37:56)*

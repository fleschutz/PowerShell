Script: *list-fritzbox-calls.ps1*
========================
...
----------
```powershell
PS> ./list-fritzbox-calls.ps1 [[-Username] <String>] [[-Password] <String>] [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of list-fritzbox-calls.ps1 as of 01/25/2024 13:58:39)*

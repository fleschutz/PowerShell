...
----------
```powershell
/home/markus/Repos/PowerShell/scripts/list-news.ps1 [[-RSS_URL] <String>] [[-maxLines] <Int32>] [[-speed] <Int32>] [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of list-news.ps1 as of 11/08/2024 12:34:51)*

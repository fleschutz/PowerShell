The 'new-memory-load.ps1' Script
========================
...
----------
```powershell
PS> ./new-memory-load.ps1 -Percent <Int32> -Seconds <Int32> [<CommonParameters>]

PS> ./new-memory-load.ps1 -Percent <Int32> -Minutes <Int32> [<CommonParameters>]
...
-------
```powershell
PS > .\Start-MemoryLoad.ps1 -Percent 80 -Minutes 15
...
-------
```powershell
PS > .\Start-MemoryLoad.ps1 -Percent 70 -Seconds 30
...
-------
```powershell
PS > .\Start-MemoryLoad.ps1 -Percent 80 -Minutes 5 -Verbose

The *list-encrypted-files.ps1* Script
===========================
...
----------
```powershell
/home/markus/Repos/PowerShell/scripts/list-encrypted-files.ps1 [[-path] <String>] [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of list-encrypted-files.ps1 as of 11/08/2024 12:37:52)*

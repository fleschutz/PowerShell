The 'convert-images2webp.ps1' Script
========================
...
----------
```powershell
PS> ./convert-images2webp.ps1 [-InputPath] <String> [-OutputDir] <String> [[-Quality] <Int32>] [[-Lossless] <Boolean>] [[-MaxParallel] <Int32>] [<CommonParameters>]
...
-------
```powershell
PS > .\convert_parallel.ps1 -InputPath .\covers -OutputDir .\covers-webp -Quality 50 -Lossless $true -MaxParallel 10
...
-------
```powershell
PS > .\convert_parallel.ps1 -InputPath .\my_image.png -OutputDir .\output -Quality 80 -Lossless $false

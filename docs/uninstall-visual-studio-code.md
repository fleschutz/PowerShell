*uninstall-visual-studio-code.ps1*
================
...
*(generated by convert-ps2md.ps1 using the comment-based help of uninstall-visual-studio-code.ps1 as of 10/19/2023 08:11:43)*

Script: *list-system-devices.ps1*
========================
...
----------
```powershell
PS> ./list-system-devices.ps1 [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of list-system-devices.ps1 as of 08/15/2024 09:50:50)*

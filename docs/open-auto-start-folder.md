The *open-auto-start-folder.ps1* Script
===========================
...
----------
```powershell
/home/markus/Repos/PowerShell/scripts/open-auto-start-folder.ps1 [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of open-auto-start-folder.ps1 as of 11/08/2024 12:37:54)*

...
----------
```powershell
/home/markus/Repos/PowerShell/scripts/install-git-extensions.ps1 [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of install-git-extensions.ps1 as of 11/08/2024 12:34:49)*

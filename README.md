...
**[Download](https://github.com/fleschutz/PowerShell/releases) | [FAQ](Docs/FAQ.md)** | **Note:** the scripts support Unicode, so a modern console is recommended (e.g. *Windows Terminal*).

...
This repository contains 40+ useful cross-platform PowerShell scripts - to be used on the command-line (CLI), for remote control (RC), by context menu, by voice control, or by automation software (e.g. Jenkins).

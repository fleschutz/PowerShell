PS> *./convert-image2blurred-frames.ps1*
====================
...
*(generated by convert-ps2md.ps1 using the comment-based help of convert-image2blurred-frames.ps1 as of 07/29/2023 10:15:07)*

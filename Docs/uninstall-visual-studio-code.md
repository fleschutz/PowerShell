PS> *uninstall-visual-studio-code.ps1*
====================
...
*(generated by convert-ps2md.ps1 using the comment-based help of uninstall-visual-studio-code.ps1 as of 07/29/2023 10:04:10)*

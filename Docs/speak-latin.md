## The *speak-latin.ps1* Script

This PowerShell script speaks the given text with a Latin text-to-speech (TTS) voice.

## Parameters
```powershell
/home/mf/Repos/PowerShell/Scripts/speak-latin.ps1 [[-text] <String>] [<CommonParameters>]
...
*Generated by convert-ps2md.ps1 using the comment-based help of speak-latin.ps1*

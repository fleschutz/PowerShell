...
.EXAMPLE
	...
	⏳ Removing directory C:\Temp and subfolder... (please wait)
	✅ Directory C:\Temp\ removed in 9s.
.LINK
...
try {
	...
	"⏳ Removing directory $path and subfolder... (please wait)"
	$lastExitCode = 0
	...
	"✅ Directory $path removed in $($elapsed)s."
	exit 0 # success
} catch {
